...
public class RenderGrinder extends TileEntitySpecialRenderer{
	...
	public void renderTileEntityAt(TileEntity tileentity, double d0, double d1,
			double d2, float f) {
		renderGrinderModelAt((TileEntityGrinder)tileentity, d0,d1,d2,f);
	      
	}
	
	private void renderGrinderModelAt(TileEntityGrinder te, double d, double d1, double d2, float f)
	   {
	      int i = 0;
	      ...
	      bindTextureByName("/mods/dnd91/minecraft/hivecraft/textures/models/struct/ModelGrinder.png");

...
public class BlockFlowingBioAcid extends BlockFlowing implements ILiquid {
	...
	protected BlockFlowingBioAcid(int par1) {
		super(par1, Material.water);
		this.setHardness(100.0f);
		this.setLightOpacity(3);
		this.setCreativeTab(HiveCraft.tabHiveCraft);
		this.setUnlocalizedName("blockBioAcidFlow");
	}

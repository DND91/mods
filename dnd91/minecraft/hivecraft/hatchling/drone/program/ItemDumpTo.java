...
import mods.dnd91.minecraft.hivecraft.hatchling.ai.EntityAIGoodDumpTo;
...
public class ItemDumpTo extends ItemProgram{

	public ItemDumpTo(int par1) {
		super(par1);
		this.program_size = 1;
		setUnlocalizedName("itemDumpTo");
	}
	
	@Override
	public void registerIcons(IconRegister ires){
		this.itemIcon = ires.registerIcon("dnd91/minecraft/hivecraft:DumpTo");
	}
	...
	public void setUpAI(EntityDrone drone, NBTTagCompound program, int pos){
		int n = pos + 1;
		drone.tasks.addTask(0, new EntityAIGoodDumpTo(drone, 0.5F, program.getCompoundTag("Slot"+n+"ID")));
